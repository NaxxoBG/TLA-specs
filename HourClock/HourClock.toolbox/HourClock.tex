...
\@x{}\moduleLeftDash\@xx{ {\MODULE} HourClock}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Naturals}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} hr}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} hr {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HCIni\@s{0.96} \.{\defeq}}%
\@y{%
 Global variables
}%
\@xx{}%
\@x{\@s{48.00} hr \.{\in} ( 1 \.{\dotdot} 12 )}%
\@pvspace{8.0pt}%
 \@x{ HCnxt \.{\defeq} hr \.{'} \.{=} {\IF} hr \.{\neq} 12 \.{\THEN} hr \.{+}
 1 \.{\ELSE} 1}%
\@pvspace{8.0pt}%
\@x{ HC \.{\defeq} HCIni \.{\land} {\Box} [ HCnxt ]_{ vars}}%
\@pvspace{8.0pt}%
\@x{ Spec \.{\defeq} HC \.{\land} {\WF}_{ vars} ( HCnxt )}%
\@pvspace{8.0pt}%
\@x{ HourInRange \.{\defeq} ( hr \.{\in} 1 \.{\dotdot} 12 )}%
\@pvspace{8.0pt}%
\@x{ {\THEOREM} Spec \.{\implies} {\Box} HourInRange}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 05 20:08:13 \ensuremath{CEST} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Feb} 05
 10:24:40 \ensuremath{CET} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\end{lcom}%
\end{document}
