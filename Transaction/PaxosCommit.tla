...
Maximum(S) == 
  ...
  (*************************************************************************)
  IF S = {} THEN -1
            ELSE CHOOSE n \in S : \A m \in S : n \geq m (* Choose one n in S where for each m in S n is greater than or equal to m. Choose is used only
            when there is exactly one n in S satisfying P *)
