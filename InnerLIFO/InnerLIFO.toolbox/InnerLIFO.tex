...
\@x{}\moduleLeftDash\@xx{ {\MODULE} InnerLIFO}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, Sequences}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} Message}%
\@y{\@s{0}%
 Set of messages that are sent but not yet received
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} in ,\, out ,\, q}%
\@pvspace{8.0pt}%
 \@x{ InChan \.{\defeq} {\INSTANCE} Channel {\WITH} Data \.{\leftarrow}
 Message ,\, chan \.{\leftarrow} in}%
\@pvspace{8.0pt}%
 \@x{ OutChan \.{\defeq} {\INSTANCE} Channel {\WITH} Data \.{\leftarrow}
 Message ,\, chan \.{\leftarrow} out}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} InChan {\bang} Init}%
\@x{\@s{35.70} \.{\land} OutChan {\bang} Init}%
\@x{\@s{35.70} \.{\land} q \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{ TypeInvariant \.{\defeq} \.{\land} InChan {\bang} TypeInvariant}%
\@x{\@s{80.80} \.{\land} OutChan {\bang} TypeInvariant}%
\@x{\@s{80.80} \.{\land} q \.{\in} Seq ( Message )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Sending ( msg ) \.{\defeq} \.{\land} InChan {\bang} Send ( msg )}%
\@x{\@s{79.54} \.{\land} {\UNCHANGED} {\langle} out ,\, q {\rangle}}%
\@pvspace{8.0pt}%
\@x{ BufRcv \.{\defeq} \.{\land} InChan {\bang} Rcv}%
 \@x{\@s{51.42} \.{\land} q \.{'} \.{=} {\langle} in . val {\rangle} \.{\circ}
 q}%
\@x{\@s{51.42} \.{\land} {\UNCHANGED} out}%
\@pvspace{8.0pt}%
\@x{ BufSend \.{\defeq} \.{\land} q \.{\neq} {\langle} {\rangle}}%
\@x{\@s{56.34} \.{\land} OutChan {\bang} Send ( Head ( q ) )}%
\@x{\@s{56.34} \.{\land} q \.{'} \.{=} Tail ( q )}%
\@x{\@s{56.34} \.{\land} {\UNCHANGED} in}%
\@pvspace{8.0pt}%
\@x{ Receiving \.{\defeq} \.{\land} OutChan {\bang} Rcv}%
\@x{\@s{60.28} \.{\land} {\UNCHANGED} {\langle} in ,\, q {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} \E\, msg \.{\in} Message \.{:} Sending ( msg )}%
\@x{\@s{39.83} \.{\lor} BufRcv}%
\@x{\@s{39.83} \.{\lor} BufSend}%
\@x{\@s{39.83} \.{\lor} Receiving}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land}\@s{14.09} {\Box} [ Next ]_{
 {\langle} in ,\, out ,\, q {\rangle}}}%
\@pvspace{8.0pt}%
\@x{ {\THEOREM} Spec \.{\implies} {\Box} TypeInvariant}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 04 20:03:05 \ensuremath{CEST} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Feb} 21
 12:23:54 \ensuremath{CET} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\end{lcom}%
\end{document}
