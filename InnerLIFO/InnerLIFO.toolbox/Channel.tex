...
\@x{}%
\@y{\@s{0}%
 Records can also be viewed as functions with their fields specifying their
 domain
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ TypeInvariant \.{\defeq} chan \.{\in} [ val \.{:} Data ,\, rdy \.{:} \{
 0 ,\, 1 \} ,\, ack \.{:} \{ 0 ,\, 1 \} ]}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} TypeInvariant}%
\@x{\@s{35.70} \.{\land} chan . ack \.{=} chan . rdy}%
\@y{\@s{0}%
 same notation as \ensuremath{chan[\mbox{``}rdy\mbox{''}]
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Definition of an action begins with its enabling \ensuremath{step.a
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Send ( d ) \.{\defeq} \.{\land} chan . rdy \.{=} chan . ack}%
 \@x{\@s{54.79} \.{\land} chan \.{'} \.{=} [ chan {\EXCEPT} {\bang} . val
 \.{=} d ,\, {\bang} . rdy \.{=} 1 \.{-} @ ]}%
\@x{}%
\@y{\@s{0}%
 Another way to define \ensuremath{chan\.{'} \.{\land} chan\.{'} \.{=}}
 [\ensuremath{val \.{\mapsto} d}, \ensuremath{rdy \.{\mapsto} 1 \.{-}
 chan.rdy}, \ensuremath{ack \.{\mapsto} chan.ack}]
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Rcv \.{\defeq} \.{\land} chan . rdy \.{\neq} chan . ack}%
 \@x{\@s{35.94} \.{\land} chan \.{'} \.{=} [ chan {\EXCEPT} {\bang} . ack
 \.{=} 1 \.{-} @ ]}%
\@y{\@s{0}%
 the same as [\ensuremath{chan} \ensuremath{{\EXCEPT}
 {\bang}}``\ensuremath{ack}'' \ensuremath{\.{=} 1 \.{-}} @]
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ( \E\, d \.{\in} Data \.{:} Send ( d ) ) \.{\lor} Rcv}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 04 20:07:37 \ensuremath{CEST} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Feb} 21
 12:22:06 \ensuremath{CET} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\end{lcom}%
\end{document}
