             ...
             start: b[self] := TRUE;
                ...
                l6: if x # self
                       then l7: b[self] := FALSE;
                            ...
                            l9: if y # self then l10: await y = 0;
                                                      goto start;
                                end if;
                    end if;
                crit: skip; (* assert \A p \in 1..N \ {self} : pc[p] # "cs" INSTEAD OF skip *)
               l11: y := 0;
               l12: b[self] := FALSE;
               end while;
end process
...
NoTwoProcInCrit == \A p, q \in 1..N : (p # q) => ~((pc[p]="cs") /\ (pc[q] = "cs"))
\* END TRANSLATION

=============================================================================
\* Modification History
\* Last modified Fri Mar 01 14:13:16 CET 2019 by Naxxo
