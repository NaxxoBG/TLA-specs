...
\@x{}\moduleLeftDash\@xx{ {\MODULE} SimpleSpec}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\VARIABLES} i ,\, pc}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Feb} 09
 14:25:07 \ensuremath{CET} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Feb} 09 14:24:59
 \ensuremath{CET} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\end{lcom}%
\end{document}
