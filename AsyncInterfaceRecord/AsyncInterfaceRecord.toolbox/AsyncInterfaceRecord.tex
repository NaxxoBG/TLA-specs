...
\setboolean{shading}{true}
 ...
 AsyncInterfaceRecord}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\@pvspace{8.0pt}%
\@x{ NextSnd ( d ) \.{\defeq}}%
\@x{\@s{47.41} \.{\land} chan . rdy \.{=} chan . ack}%
 \@x{\@s{47.41} \.{\land} chan \.{'} \.{=} [ chan {\EXCEPT} {\bang} . val
 \.{=} d ,\, {\bang} . rdy \.{=} 1 \.{-} @ ]}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ NextAck \.{\defeq} \.{\land} chan . rdy \.{\neq} chan . ack}%
 \@x{\@s{56.08} \.{\land} chan \.{'} \.{=} [ chan {\EXCEPT} {\bang} . ack
 \.{=} 1 \.{-} @ ]}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} ( \E\, d \.{\in} Data \.{:} NextSnd ( d ) ) \.{\lor}
 NextAck}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 19 10:44:11 \ensuremath{CET} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Feb} 12
 10:20:08 \ensuremath{CET} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\end{lcom}%
\end{document}
