...
\@x{}\moduleLeftDash\@xx{ {\MODULE} intro}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Naturals}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxtrue
\@x{\@s{8.2} {\p@mmalgorithm} Clock {\p@lbrace}}%
\@pvspace{8.0pt}%
\@x{ {\p@variables} hour \.{\in} 0 \.{\dotdot} 11 {\p@semicolon}}%
 \@x{\@s{16.4} {\p@fair} {\p@process} {\p@lparen} Proc \.{=} 1 {\p@rparen}
 {\p@lbrace}}%
 \@x{\@s{32.8} start\@s{.5}\textrm{:}\@s{3}\@s{1.78} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen} {\p@lbrace}}%
\@x{\@s{49.19} hour \.{:=} ( hour \.{+} 1 ) \.{\%} 12 {\p@semicolon}}%
\@x{\@s{32.8} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@x{ {\VARIABLE} hour}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} hour {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} \{ 1 \}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{4.12} \.{\defeq}}%
...
\@xx{}%
\@x{\@s{39.83} \.{\land} hour \.{\in} 0 \.{\dotdot} 11}%
\@pvspace{8.0pt}%
\@x{ Proc\@s{0.68} \.{\defeq} hour \.{'} \.{=} ( hour \.{+} 1 ) \.{\%} 12}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} Proc}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} \.{\land} Init \.{\land} {\Box} [ Next ]_{
 vars}}%
\@x{\@s{39.83} \.{\land} {\WF}_{ vars} ( Proc )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 END TRANSLATION
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ hourInRange \.{\defeq} {\Box} ( hour \.{\leq} 12 )}%
\@y{\@s{0}%
 State predicate
}%
\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 05 19:00:51 \ensuremath{CEST} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Jan} 31
 10:15:52 \ensuremath{CET} 2019 by \ensuremath{Naxxo
}%
\end{cpar}%
\end{lcom}%
\end{document}
